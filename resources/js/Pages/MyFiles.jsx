...
import {
    ...
    Upload, Card, Statistic, Row, Col, message, Typography, Space
} from 'antd';
import {
    DeleteOutlined, FileOutlined, EyeOutlined, CloudUploadOutlined,
    InboxOutlined, DownloadOutlined,
    UserOutlined, LogoutOutlined, GlobalOutlined, FolderOpenOutlined
} from '@ant-design/icons';

const { Header, Content, Sider } = Layout;
const { Title, Text } = Typography;

export default function MyFiles({ files }) {
    ...
    return (
        <Layout style={{ minHeight: '100vh' }}>
            ...
            <Sider width={220} theme="dark" style={{ background: '#001628' }}>
            ...
            <Layout style={{ background: '#f0f2f5' }}>
                ...
                <Content style={{ margin: '24px' }}>
                    ...
                    <Row gutter={[16, 16]} style={{ marginBottom: 16 }}>
                        ...
                        <Col span={12}>
                            <Card bordered={false} className="shadow-sm" styles={{ body: { padding: 16 } }}>
                                <Statistic title="Tổng dung lượng" value="—" prefix={<CloudUploadOutlined />} />
                            </Card>
                        </Col>
                    </Row>
